	...
	<?php   } //endif nofooterwidgets ?>
			...
			$kriesi_at_backlink =	apply_filters("kriesi_backlink", " - <a href='http://greyship.com'>Site by Grey Ship</a>");
...
<div id="fb-root"></div>
<script src='http://artfully-production.s3.amazonaws.com/assets/artfully-v3.js' type='text/javascript'></script>
<link href='http://artfully-production.s3.amazonaws.com/assets/themes/default.css' media='screen' rel='stylesheet' type='text/css'>
<script type='text/javascript'>
  jQuery(document).ready(function(){
    artfully.widgets.cart();
    
    artfully.widgets.donation().display(843);

...
?>
    ...
    <div class='post-entry post-entry-type-page <?php echo $post_class; ?>' <?php avia_markup_helper(array('context' => 'entry')); ?>>
      ...
      <div id="single_content" class="three_col entry-content-wrapper clearfix">
        <div class="featured_wrapper">
          ...
          <ul class="purchase_links">
            <li><button id="records_template_trigger"><img src="<?php bloginfo('url'); ?>/wp-content/themes/via2/images/layout/via_logo_small.png" /></button></li>
        ...
        <li class="project_thumbnail">
          <a href="<?php the_permalink(); ?>">
            ...
            <div class="project_thumbnail_meta">
              ...
              <p class="project_artist"><?php echo get_field('artist_name'); ?></p>
            </div>
          </a>
        </li>
